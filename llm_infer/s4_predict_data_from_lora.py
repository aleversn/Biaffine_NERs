...
parser.add_argument('--file_name', default='ud', help='file name of the dataset, you should make sure it contains `test.jsonl` file')
parser.add_argument('--save_type_name', default='Llama3', help='the prefix name of save dir (usually is the LLM name)')
parser.add_argument('--model_from_pretrained', default='/home/lpc/models/Meta-Llama-3-8B-Instruct/', help='model from pretrained')
parser.add_argument('--peft_pretrained', default='/home/lpc/repos/ChatGLM_PEFT/save_model/fewshot_ner_1000/ChatGLM_16000/', help='model from pretrained')
